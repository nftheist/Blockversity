    ...
    return(
        <div className="home">
            ...
            <div className="collection">
                <div className="collection_card card1" onClick={() => navigateTo('/app/Smart')}>
                    ...
                    <div className="collection_card_circle">
                       {/*<div className="collection_card_circle1"></div>
                        ...
                        <Image src={image1} className="collection_card_circle1"/>
                        <Image src={image2} className="collection_card_circle2"/>
                        <Image src={image3} className="collection_card_circle3"/>
                ...
                <div className="collection_card card2" onClick={() => navigateTo('/app/Clever')}>
                <div className="collection_card_title">The Clever<br/> Owls Collection</div>
                    ...
                    <div className="collection_card_circle">
                       {/*<div className="collection_card_circle1"></div>
                        <div className="collection_card_circle2"></div>
                        <div className="collection_card_circle3"></div>*/}
                        <Image src={image4} className="collection_card_circle1  cards11"/>
                        <Image src={image5} className="collection_card_circle2 cards12"/>
                        <Image src={image6} className="collection_card_circle3 cards13"/>
                ...
                <div className="collection_card card3" onClick={() => navigateTo('/app/Brilliant')}>
                    ...
                    <div className="collection_card_circle">
                       {/*<div className="collection_card_circle1"></div>
                        <div className="collection_card_circle2"></div>
                        <div className="collection_card_circle3"></div>*/}
                        <Image src={image7} className="collection_card_circle1 cards21"/>
                        <Image src={image8} className="collection_card_circle2 cards22"/>
                        <Image src={image9} className="collection_card_circle3 cards23"/>
